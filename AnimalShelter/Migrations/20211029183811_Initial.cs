    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 6, "Main coon", "Sam is an easy going boy. He loves to lounge around with people and chase lasers.", "male", "Sam", 15 });

            migrationBuilder.InsertData(
                table: "Dogs",
                columns: new[] { "DogId", "Age", "Breed", "Description", "Gender", "Name", "Weight" },
                values: new object[] { 1, 1, "Texas-Heeler", "Arlo is a fun loving pup with a lot of energy.", "male", "Arlo", 39 });
        }
